...
def _write_calibration_markdown(
    ...
    lines = [
        ...
        "",
        f"![v8.1 阈值校准诊断]({Path(threshold_figure).as_posix().replace('docs/', '../')})",
        "",
        f"![v8.1 分数分布]({Path(score_figure).as_posix().replace('docs/', '../')})",
        "",
        "## 核心表",
        "",
        "| " + " | ".join(table.columns) + " |",
...
def _write_encoder_comparison_markdown(
    ...
    lines = [
        ...
        "",
        f"![v8.2 Encoder 对比]({Path(figure_path).as_posix().replace('docs/', '../')})",
        "",
        "## 每个协议/数据集的最优 Encoder",
        "",
...
def _write_autoaug_markdown(
    ...
    lines = [
        ...
        intro,
        "",
        f"![{figure_alt}]({Path(figure_path).as_posix().replace('docs/', '../')})",
        "",
        "## Baseline vs AutoAug",
        "",
...
def compare_semantic_v8_protocols(
    ...
    output_csv: str | Path = "docs/experiments/semantic_v8_protocol_results.csv",
    output_md: str | Path = "docs/experiments/semantic_v8_protocol_results.md",
    split_csv: str | Path = "docs/experiments/semantic_v8_protocol_splits.csv",
...
def compare_semantic_v8_encoders(
    ...
    output_csv: str | Path = "docs/experiments/semantic_v8_encoder_comparison.csv",
    output_md: str | Path = "docs/experiments/semantic_v8_encoder_comparison.md",
    error_csv: str | Path = "docs/experiments/semantic_v8_encoder_errors.csv",
    figure_path: str | Path = "docs/figures/semantic_v8_encoder_comparison.svg",
    batch_size: int = 64,
    device: str | None = None,
    test_size: float = 0.3,
    validation_size: float = 0.2,
...
def compare_semantic_v8_auto_augmentation(
    ...
    external_data_paths: Sequence[tuple[str, str | Path]],
    challenge_data_paths: Sequence[tuple[str, str | Path]] = (),
    output_csv: str | Path = "docs/experiments/semantic_v8_autoaug_results.csv",
    output_md: str | Path = "docs/experiments/semantic_v8_autoaug_results.md",
    terms_csv: str | Path = "docs/experiments/semantic_v8_autoaug_terms.csv",
    examples_csv: str | Path = "docs/experiments/semantic_v8_autoaug_examples.csv",
    figure_path: str | Path = "docs/figures/semantic_v8_autoaug_delta.svg",
    model_name: str = "BAAI/bge-small-zh-v1.5",
    batch_size: int = 64,
    device: str | None = None,
    test_size: float = 0.3,
...
def compare_semantic_v8_filtered_auto_augmentation(
    ...
    external_data_paths: Sequence[tuple[str, str | Path]],
    challenge_data_paths: Sequence[tuple[str, str | Path]] = (),
    output_csv: str | Path = "docs/experiments/semantic_v8_autoaug_filtered_results.csv",
    output_md: str | Path = "docs/experiments/semantic_v8_autoaug_filtered_results.md",
    terms_csv: str | Path = "docs/experiments/semantic_v8_autoaug_filtered_terms.csv",
    examples_csv: str | Path = "docs/experiments/semantic_v8_autoaug_filtered_examples.csv",
    figure_path: str | Path = "docs/figures/semantic_v8_autoaug_filtered_delta.svg",
    model_name: str = "BAAI/bge-small-zh-v1.5",
    batch_size: int = 64,
    device: str | None = None,
    test_size: float = 0.3,
...
def diagnose_semantic_v8_calibration(
    ...
    external_data_paths: Sequence[tuple[str, str | Path]],
    challenge_data_paths: Sequence[tuple[str, str | Path]] = (),
    diagnostics_csv: str | Path = "docs/experiments/semantic_v8_calibration_diagnostics.csv",
    threshold_grid_csv: str | Path = "docs/experiments/semantic_v8_threshold_grid.csv",
    score_samples_csv: str | Path = "docs/experiments/semantic_v8_score_samples.csv",
    pr_curve_csv: str | Path = "docs/experiments/semantic_v8_pr_curve.csv",
    output_md: str | Path = "docs/experiments/semantic_v8_calibration_diagnostics.md",
    threshold_figure: str | Path = "docs/figures/semantic_v8_threshold_gain.svg",
    score_figure: str | Path = "docs/figures/semantic_v8_score_distribution.svg",
    model_name: str = "BAAI/bge-small-zh-v1.5",
    batch_size: int = 64,
    device: str | None = None,
    test_size: float = 0.3,
