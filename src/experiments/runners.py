...
def compare_baselines(
    data_path: str | Path,
    output_csv: str | Path = "docs/experiments/classic/baseline_comparison.csv",
    output_md: str | Path = "docs/experiments/classic/baseline_comparison.md",
    test_size: float = 0.3,
    random_state: int = 42,
) -> pd.DataFrame:
...
def compare_csn_optimization(
    ...
    output_csv: str | Path = "docs/experiments/classic/csn_comparison.csv",
    output_md: str | Path = "docs/experiments/classic/csn_comparison.md",
    test_size: float = 0.3,
    random_state: int = 42,
) -> pd.DataFrame:
...
def compare_bad_case_optimization(
    data_path: str | Path,
    adversarial_path: str | Path,
    output_csv: str | Path = "docs/experiments/classic/bad_case_optimization.csv",
    output_md: str | Path = "docs/experiments/classic/bad_case_optimization.md",
    grid_csv: str | Path = "docs/experiments/classic/bad_case_tuning_grid.csv",
    test_size: float = 0.3,
...
def compare_score_fusion_optimization(
    data_path: str | Path,
    adversarial_path: str | Path,
    output_csv: str | Path = "docs/experiments/classic/fusion_experiment.csv",
    output_md: str | Path = "docs/experiments/classic/fusion_experiment.md",
    stability_csv: str | Path = "docs/experiments/classic/fusion_stability.csv",
    test_size: float = 0.3,
    validation_size: float = 0.2,
    random_state: int = 42,
...
def compare_multidataset_fusion_validation(
    ...
    output_csv: str | Path = "docs/experiments/multidataset/multidataset_fusion_validation.csv",
    output_md: str | Path = "docs/experiments/multidataset/multidataset_fusion_validation.md",
    test_size: float = 0.3,
    validation_size: float = 0.2,
    random_state: int = 42,
) -> pd.DataFrame:
...
def compare_all_versions_multidataset_validation(
    train_data_path: str | Path,
    eval_data_paths: Sequence[tuple[str, str | Path]] = (),
    output_csv: str | Path = "docs/experiments/multidataset/all_versions_multidataset_validation.csv",
    output_md: str | Path = "docs/experiments/multidataset/all_versions_multidataset_validation.md",
    test_size: float = 0.3,
    validation_size: float = 0.2,
    random_state: int = 42,
) -> pd.DataFrame:
...
def compare_domain_adaptation_validation(
    ...
    output_csv: str | Path = "docs/experiments/domain_adaptation/domain_adaptation_validation.csv",
    output_md: str | Path = "docs/experiments/domain_adaptation/domain_adaptation_validation.md",
    adaptation_summary_csv: str | Path = "docs/experiments/domain_adaptation/domain_adaptation_splits.csv",
    test_size: float = 0.3,
    validation_size: float = 0.2,
...
def compare_evaluation_protocols(
    ...
    challenge_data_paths: Sequence[tuple[str, str | Path]] = (),
    output_csv: str | Path = "docs/experiments/multidataset/evaluation_protocol_results.csv",
    output_md: str | Path = "docs/experiments/multidataset/evaluation_protocol_results.md",
    split_csv: str | Path = "docs/experiments/multidataset/evaluation_protocol_splits.csv",
    test_size: float = 0.3,
    validation_size: float = 0.2,
    adapt_train_size: float = 0.3,
    random_state: int = 42,
