...
- `docs/experiments/overview/latest_results_summary.md`：最新结果总览
- `docs/experiments/overview/optimization_log.md`：完整优化记录
- `docs/experiments/multidataset/evaluation_protocol_results.md`：统一评测协议结果
- `docs/experiments/semantic_v8/semantic_v8_protocol_results.md`：v8.0 语义编码实验结果
- `docs/experiments/semantic_v8/semantic_v8_autoaug_filtered_results.md`：v8.3b 筛选增强 + hard negative 实验结果
- `docs/references/evaluation/evaluation_protocol.md`：统一评测协议定义
- `docs/experiments/domain_adaptation/domain_adaptation_validation.md`：v6/v7 跨来源适配实验
...
├── docs/
│   ├── experiments/         # 按 overview/classic/multidataset/domain_adaptation/semantic_v8 分类
│   ├── figures/             # 按 classic/semantic_v8 分类
│   ├── references/          # 按 course/data/evaluation 分类
│   └── reports/             # 课程报告摘要材料
├── models/                  # 训练后的模型，默认不提交
├── requirements.txt
├── pyproject.toml
...
python -m src.cli validate-domain-adaptation \
  ...
  --out-csv docs/experiments/domain_adaptation/domain_adaptation_validation_10pct.csv \
  --out-md docs/experiments/domain_adaptation/domain_adaptation_validation_10pct.md \
  --split-csv docs/experiments/domain_adaptation/domain_adaptation_splits_10pct.csv
```
...
- 若新增外部数据源，请同步更新 `docs/references/data/data_sources.md`。
- 提交前建议运行：
