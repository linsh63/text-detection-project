...
- `docs/experiments/domain_adaptation_validation.csv`
- `docs/experiments/domain_adaptation_validation.md`
- `docs/experiments/domain_adaptation_splits.csv`

另外补充扫描了 10% 和 20% 外部适配比例：

- `docs/experiments/domain_adaptation_validation_10pct.csv`
- `docs/experiments/domain_adaptation_validation_20pct.csv`
...
- `docs/references/evaluation_protocol.md`
