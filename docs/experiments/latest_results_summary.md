...
当前旧版模型 v0-v7 的最终评测入口是 `evaluation_protocol_results.md`，v8.0 语义模型的第一轮结果见 `semantic_v8_protocol_results.md`。两者使用同一套四类协议：
...
| 文件 | 内容 |
|---|---|
| `evaluation_protocol_results.csv` | v0-v7 统一评测协议结果 |
| `semantic_v8_protocol_results.csv` | v8.0 语义编码统一评测结果 |
| `semantic_v8_protocol_splits.csv` | v8.0 协议评测中的外部数据切分 |
| `semantic_v8_calibration_diagnostics.csv` | v8.1 阈值校准诊断汇总 |
| `semantic_v8_calibration_diagnostics.md` | v8.1 诊断报告和图表入口 |
| `semantic_v8_threshold_grid.csv` | v8.1 阈值扫描明细 |
| `semantic_v8_encoder_comparison.csv` | v8.2 多 encoder 对比结果 |
| `semantic_v8_encoder_comparison.md` | v8.2 多 encoder 对比报告 |
| `semantic_v8_autoaug_results.csv` | v8.3a 自动 hard-case 增强结果 |
| `semantic_v8_autoaug_results.md` | v8.3a 自动 hard-case 增强报告 |
| `semantic_v8_autoaug_terms.csv` | v8.3a 自动挖掘片段 |
| `semantic_v8_autoaug_filtered_results.csv` | v8.3b 筛选增强 + hard negative 结果 |
| `semantic_v8_autoaug_filtered_results.md` | v8.3b 筛选增强 + hard negative 报告 |
| `semantic_v8_autoaug_filtered_terms.csv` | v8.3b 正负增强片段 |
| `semantic_v8_autoaug_filtered_examples.csv` | v8.3b 生成样本明细 |
| `evaluation_protocol_splits.csv` | 协议评测中的外部数据切分 |
